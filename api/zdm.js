...
const zdm_config = {
    "rule1": {
        "Status": 1,
        "title_gjc": "博乐纯|清朗一日|欧舒适|清氧清|欧柯视|南星|五常|花生油|吉列|水次元",
...
<a href="{链接}" target="_blank" style="background-color:#317f6f; color:white; padding:8px 16px; text-decoration:none; border-radius:5px;">打开商品链接（点击跳转值得买原文购买）</a>
